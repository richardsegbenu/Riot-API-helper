...
I play LoL, embarassingly and unfortunately so. Every lobby is different, not always in a good way, in champ select I want quick counter-pick options - even though I'm absolutely horror at half the champs - and after a session I want to see whether my form is real or whether I'm just on another tilt streak - commonly the latter. There are great web tools for each of these (op.gg, u.gg, mobalytics) but I wanted something that lived in my terminal, ran with one command, and let me handle the data my own way. I love all things efficiency so this saves me time, effort, and sets me free from having 14 tabs crushing my RAM.
